...
/* set to table */
inline void setobj2t(lua_State *L, const TValue *tbl, const TValue *key,
...
/* set to upvalue */
inline void setobj2uv(lua_State *L, const TValue *func, TValue *dst,
                      const TValue *src) {
  lua_unused(func);
  setobj(L, dst, src);
}
...
inline void setobjt2s(lua_State *L, const TValue *tbl, const TValue *key,
                      TValue *dst, const TValue *src) {
  lua_unused(tbl);
  lua_unused(key);
  setobj2s(L, dst, src);
...
inline void setobjuv2s(lua_State *L, const TValue *func, TValue *dst,
                       const TValue *src) {
  lua_unused(func);
  setobj2s(L, dst, src);
}
