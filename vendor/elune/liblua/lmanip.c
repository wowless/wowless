...
extern void setobj2t(lua_State *L, const TValue *tbl, const TValue *key,
                     TValue *dst, const TValue *src);
extern void setobj2uv(lua_State *L, const TValue *func, TValue *dst,
                      const TValue *src);
extern void setobjt2s(lua_State *L, const TValue *tbl, const TValue *key,
                      TValue *dst, const TValue *src);
extern void setobjuv2s(lua_State *L, const TValue *func, TValue *dst,
                       const TValue *src);
