...
local yamls = {
  ...
  'data/products/wow_beta/apis.yaml',
  'data/products/wow_beta/build.yaml',
  'data/products/wow_beta/config.yaml',
  'data/products/wow_beta/cvars.yaml',
  'data/products/wow_beta/events.yaml',
  'data/products/wow_beta/globals.yaml',
  'data/products/wow_beta/structures.yaml',
  'data/products/wow_beta/uiobjects.yaml',
  'data/products/wow_beta/xml.yaml',
