...
local env = {
  ...
  Enum = {
    CalendarEventType = {},
    QuestTag = {
      Account = 'UNIMPLEMENTED:Account',
      Dungeon = 'UNIMPLEMENTED:Dungeon',
      Group = 'UNIMPLEMENTED:Group',
      Heroic = 'UNIMPLEMENTED:Heroic',
      Legendary = 'UNIMPLEMENTED:Legendary',
      PvP = 'UNIMPLEMENTED:PvP',
      Raid = 'UNIMPLEMENTED:Raid',
      Raid10 = 'UNIMPLEMENTED:Raid10',
      Raid25 = 'UNIMPLEMENTED:Raid25',
